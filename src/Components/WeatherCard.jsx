...
const WeatherCard = (
  ...
  return (
    ...
    <div className='w-[22rem] min-w-[22rem] h-[30rem] glasscardp-4'>
      ...
      <div className='w-full flex justify-between items-center mt-4 gap-4'>
        <p className='flex-1 text-center p-2 font-bold bg-blue-600 shadow rounded-lg'>
          Wind Speed
          <p className='font-normal'>{windspeed}</p>
        </p>
      ...
      <div className='w-full p-3 mt-4 flex justify-between items-cenyer'>
